...
const initialRows = [
  createData(1, 'Precificação', 'Realizar o custo do Produto', '2025-01-01', '2025-01-02', 'Não iniciado', 'Recurso 1'),
  createData(2, 'Fornecedores', 'Cadastrar todos os fornecedores', '2024-01-03', '2025-01-04', 'Não iniciado', 'Recurso 2'),
  createData(3, 'Insumos', 'Listagem de ingredientes', '2024-12-01', '2025-01-01', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Cadastro de Produtos', 'Catalogar Produtos', '2024-12-01', '2025-02-01', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Estoque', 'Contagem de Produtos', '2025-01-06', '2025-01-07', 'Aguardando inicialização', 'Recurso 5'),
  createData(6, 'Clientes', 'Cadastro de clientes', '2025-01-07', '2025-01-08', 'Aguardando inicialização', 'Recurso 6'),
];
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          ...
          subheader="Listagem Tarefas Do meu Jeito Doces "
        /> 
        <CardContent>
